...
# Classe de popup, printa uma tela em branco (terá interações diferentes para cada local, onde cada um será responsável por printar suas
# interações separadamente), e faz a verificação de fechamento do popup no X do canto superior direito do popup
class Popup:
    def __init__(self):
