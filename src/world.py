...
class World:
    def __init__(self):
        ...
        # Cria as instâncias de cada um dos locais do mapa
    ...
    # Método que cria a imagem de fundo do jogo
    def build_screen(self, screen):
        background_image = pygame.image.load('imagens/grass_background.jpg')
        background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))
        screen.blit(background_image, (0, 0))

    # Método que constrói o mundo, pondo os locais em seus devidos lugares e printa no canto inferior direito, quantos dias se passaram
    ...
    # Constrói o menu principal, que tem como opções rodar o jogo (play), mostrar o tutorial do jogo (tutorial) e fechar o jogo (quit)
